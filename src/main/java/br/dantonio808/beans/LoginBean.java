...
public class LoginBean {
	 ...
	 * @return resultado
	 *
	 * M�todo que faz o procedimento de logar,
	 * primeiro checa se o usuario digitou valores v�lidos 
	 * e solicita a fachada para que autentique,
	 * � respons�vel pelas mensagens de erro que voltar�o � p�gina de login
	 * em casos de erros.
	 */
	 ...
	 * @return retorno
	 * 
	 *M�todo que faz o processo de deslogar.
	 *Basicamente retira o usuario da sess�o e redireciona pro home.
	 */
	...
	/**
	 * M�todo que faz a carga do ResourceBundle de onde as mensagens de erro vir�o
	 ...
	 * @return msg
	 * 
	 * M�todo que carrega a mensagem apropriada de acordo com
